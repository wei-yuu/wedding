<template>
  <event-card>
    <section class="col-span-2 flex flex-wrap items-center justify-center">
      <h2 class="w-full text-center text-4xl">Map</h2>
      <div class="whitespace-pre text-xl">
        <div
          ...
          :key="index"
        >
          <label class="col-span-4">{{ info.label }}</label>
          <span class="col-span-1" />
          <p class="col-span-3 whitespace-pre-line">{{ info.text }}</p>
        </div>
      </div>
    </section>
    <section class="col-span-3 flex flex-wrap items-center justify-center">
      <iframe
        class="h-[90%] w-11/12 shadow-lg"
...
const information = ref([
  ...
  {
    label: '搭乘火車',
    text: '由清水車站轉乘３０４公車或計程車。',
  },
  {
    label: '搭乘客運',
    text: '由台中中港轉運站轉乘３０３公車或計程車。',
  },
]);
</script>
